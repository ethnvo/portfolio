    ...
    <div className="min-h-screen w-full bg-ground flex flex-col items-center justify-center gap-8 py-16 overflow-auto">
      <div className="w-full overflow-auto flex justify-center">
        ...
        >
          ...
          <div className="absolute right-[-260px] top-1/2 -translate-y-1/2 h-[760px] w-[760px] rounded-full border border-white/[0.07] pointer-events-none" />
          <div className="absolute right-[-160px] top-1/2 -translate-y-1/2 h-[560px] w-[560px] rounded-full border border-white/[0.11] pointer-events-none" />
          <div className="absolute right-[-70px] top-1/2 -translate-y-1/2 h-[380px] w-[380px] rounded-full border border-brand/30 pointer-events-none" />
