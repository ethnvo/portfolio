...
const Navbar = () => {
    ...
    return (
        <header className='fixed top-0 w-full blackdrop-blur-md bg-black/30 border-b border-gray-700 border-opacity-20 z-50'> 
            <nav className= 'max-w-7xl mx-auto py-6 lg:px-32 flex items-center justify-between text-white'>
                <a href="#about" className= 'text-xl md:text-2xl pl-5 font-semibold bg-gradient-to-r to-pink-300 via-pink-400 from-rose-500 text-transparent bg-clip-text hover:scale-110 transition-all duration-300'>
                    Ethan Vo
                </a>
                ...
                <button className='md:hidden' onClick={() => setIsMenuOpen
                (!isMenuOpen)}>
